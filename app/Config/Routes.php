...
$routes->get('/user', 'User\Main::index');
$routes->add('usuarios', 'User\Main::index');
$routes->add('usuario', 'User\Add::index');
$routes->add('usuario/save', 'User\Add::save');
$routes->add('usuario/update/(:num)', 'User\Edit::save/$1');
